...
const matrix: Record<RoleName, string[]> = {
  ...
  supervisor: ["dashboard:view", "reports:view", "admin:operational", "controls:write", "picking:view", "team-picking:manage"],
  controlista: ["dashboard:view", "admin:operational", "controls:write", "picking:view", "team-picking:manage"],
